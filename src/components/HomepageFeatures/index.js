...
const FeatureList = [
  {
    ...
    description: (
      <Translate
        ...
        Comprehensive guides for using QA Assistants, a WordPress plugin.
  ...
  },
  {
    ...
    description: (
      <Translate
        ...
        Technical documentation for developers working with QA Assistants.
  ...
  },
  {
    ...
    description: (
      <Translate
        ...
        QA Assistants is designed with privacy in mind, providing analytics
